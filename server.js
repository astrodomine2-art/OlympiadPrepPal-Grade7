...
// This endpoint dynamically creates a script to expose the API_KEY to the window object.
// It's crucial this route is defined before the static middleware.
app.get('/env.js', (req, res) => {
  res.setHeader('Content-Type', 'application/javascript');
  res.send(`
    // This creates the process.env object in the browser, making the API_KEY available.
    window.process = {
      env: {
